          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: AppSpacing.sm),
                const Text(
                  'Rejoignez VORA et voyagez en toute sécurité.',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: const [
                          Text('Vos données et transactions sont protégées',
                              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: AppColors.navy)),
                          Text('VORA utilise un chiffrement de bout en bout.',
    ...
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: active ? AppColors.green : const Color(0xFFE4E5E2),
