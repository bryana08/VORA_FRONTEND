...
import 'carpool_booking_screen.dart';
              ...
              child: Row(
                children: [
                  ...
                  Stack(clipBehavior: Clip.none, children: [
                    ...
                    Positioned(right: -2, top: -2, child: Container(width: 8, height: 8, decoration: const BoxDecoration(color: AppColors.green, shape: BoxShape.circle))),
                  ]),
                ],
              ),
            ),
                  ...
                  Row(children: [
                    Expanded(
                      child: _RideTypeCard(
                        ...
                        subtitle: 'Partagez et économisez',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CarpoolBookingScreen())),
                      ),
                    ),
                    ...
                    Expanded(
                      child: _RideTypeCard(
                        ...
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PriceNegotiationScreen())),
                      ),
                    ),
                  ]),
                ],
...
class _MapPin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: AppColors.card, borderRadius: BorderRadius.circular(AppRadius.sm), boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.08), blurRadius: 4)]),
...
class _RideTypeCard extends StatelessWidget {
  ...
  const _RideTypeCard({required this.icon, required this.title, required this.subtitle, required this.onTap});
  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onTap,
